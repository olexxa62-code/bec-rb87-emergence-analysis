...
We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy scientific community.
...
- Providing and receiving constructive peer review
- Maintaining scientific rigor and integrity
- Properly citing sources and acknowledging contributions
- Adhering to academic standards of conduct
...
- Misrepresenting others' work or contributions
...
- Clearly distinguish between data, calculations, and interpretations
- Document methodology completely
- Report uncertainties accurately
...
- Be respectful of the contributor's effort
...
- Follow standard academic citation practices
...
Contributions to this repository do not automatically confer authorship on resulting publications. Authorship decisions follow standard academic criteria:
...
- Properly document shared resources
...
- Standard academic research ethics guidelines
...
- Direct email to maintainer (for confidential matters)

---

**Version:** 1.0  
**Last Updated:** November 15, 2025  
**Applies to:** All project spaces and official project representation
